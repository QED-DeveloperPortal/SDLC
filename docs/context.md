...
### Use only synthetic data
    Only use synthetic data that does not identify with any real world people or places. You can achieve this by using data generated by the DevPortal DataForge facility for example. 
